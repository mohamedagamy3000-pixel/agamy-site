...
const SITE = {
  ...
  /* ---------- الأعمال ----------
     stage: "produced"    → فوق، بشبكة صور كبيرة
     stage: "development" → تحت، سطر مختصر من غير صورة        */
  works: [
    {
      id: "moussa",
      published: true,
    ...
    /* ---------- تحت التطوير ----------
       🔒 الأسامي بس. ممنوع تكتب هنا لوجلاين أو أسامي شخصيات أو حبكة أو
       نهاية أو أي تفصيلة إنتاجية — الملف ده بيترفع على الإنترنت.
       اللي يهمه مشروع بيتواصل وبتبعتله التفاصيل بنفسك. */

    {
      id: "ezbet-allam",
      published: true,
      stage: "development",
      title:  { ar: "عزبة علام", en: "Ezbet Allam" },
      format: { ar: "فيلم قصير", en: "Short film" },
      genre:  { ar: "دراما عائلية", en: "Family drama" },
      year:   "2026",
      role:   { ar: "كتابة وإخراج", en: "Written & Directed" },
      status: { ar: "معالجة درامية جاهزة", en: "Treatment complete" },
      logline:{ ar: "", en: "" },
      poster: "", stills: [], video: null,
      notes:  null
    },

    {
      ...
      published: true,
      stage: "development",
      title:  { ar: "السايس", en: "The Valet" },
      format: { ar: "فيلم قصير · ١٤ د", en: "Short film · 14 min" },
      genre:  { ar: "كوميديا سوداء", en: "Black comedy" },
      year:   "2026",
      role:   { ar: "كتابة وإخراج", en: "Written & Directed" },
...

    {
      ...
      published: true,
      stage: "development",
      title:  { ar: "الحادثة", en: "The Accident" },
      format: { ar: "فيلم قصير · ١٣ د", en: "Short film · 13 min" },
      genre:  { ar: "دراما شارع", en: "Street drama" },
      year:   "2026",
      role:   { ar: "كتابة وإخراج", en: "Written & Directed" },
      status: { ar: "مسودة سيناريو كاملة", en: "Full script draft" },
      logline:{ ar: "", en: "" },
      poster: "", stills: [], video: null,
      notes:  null
    },

    {
      ...
      published: true,
      stage: "development",
      title:  { ar: "وعود مسمومة", en: "Poisoned Promises" },
      format: { ar: "فيلم قصير · ٢٠ د", en: "Short film · 20 min" },
      genre:  { ar: "دراما نفسية", en: "Psychological drama" },
      year:   "2026",
      role:   { ar: "كتابة وإخراج", en: "Written & Directed" },
      status: { ar: "قيد إعادة الكتابة", en: "In rewrite" },
      logline:{ ar: "", en: "" },
      poster: "", stills: [], video: null,
      notes:  null
    }
